...
class GuestLearningModePageA extends StatefulWidget {
  final String text6;
  GuestLearningModePageA({
    Key key,
    this.text6 =
  ...
  @override
  State<GuestLearningModePageA> createState() => _GuestLearningModePageAState();
}

class _GuestLearningModePageAState extends State<GuestLearningModePageA> {
