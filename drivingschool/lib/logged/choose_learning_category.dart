...
import '../logged/learning_mode_page_a.dart';
import '../logged/learning_mode_page_b.dart';
import '../logged/learning_mode_page_c.dart';
import 'package:flutter_svg/flutter_svg.dart';

//import '../logged/exam_mode_page.dart';
//import '../logged/learning_mode_page.dart';

class ChooseLearningCategory extends StatelessWidget {
  final String text5;
  final String text4;
  final String text3;
  final String text6;
          ...
          Pinned.fromPins(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => LearningModePageB()),
                );
              },
              child: const Text(
                'Kategoria B',
          ...
          Pinned.fromPins(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => LearningModePageA()),
                );
              },
              child: const Text(
                'Kategoria A',
