...
import '../guest/guest_learning_mode_page_a.dart';
import '../guest/guest_learning_mode_page_b.dart';
import '../guest/guest_learning_mode_page_c.dart';
import 'package:flutter_svg/flutter_svg.dart';

//import '../logged/exam_mode_page.dart';
//import '../logged/learning_mode_page.dart';

class GuestChooseLearningCategory extends StatelessWidget {
  final String text5;
  final String text4;
  final String text3;
  final String text6;
  final String text2;
  GuestChooseLearningCategory({
    Key key,
          ...
          Pinned.fromPins(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => GuestLearningModePageB()),
                );
              },
              child: const Text(
                'Kategoria C',
          ...
          Pinned.fromPins(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => GuestLearningModePageA()),
                );
              },
              child: const Text(
                'Kategoria A',
