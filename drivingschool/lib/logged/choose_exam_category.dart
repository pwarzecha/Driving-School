...
import './exam_mode_page_a.dart';
import './exam_mode_page_b.dart';
import './exam_mode_page_c.dart';
import 'package:flutter_svg/flutter_svg.dart';

import '../logged/exam_mode_page.dart';
import '../logged/learning_mode_page.dart';

class ChooseExamCategory extends StatelessWidget {
  final String text5;
  final String text4;
  final String text3;
  final String text6;
          ...
          Pinned.fromPins(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ExamModePageC()),
                );
              },
              child: const Text(
                'Kategoria C',
          ...
          Pinned.fromPins(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ExamModePageB()),
                );
              },
              child: const Text(
                'Kategoria B',
          ...
          Pinned.fromPins(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ExamModePageA()),
                );
              },
              child: const Text(
                'Kategoria A',
