...
import 'package:drivingschool/sign_up_page.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
              Pin(size: 123.0, middle: 0.8),
              Pin(size: 103.0, middle: 0.1753),
              child:
