import 'package:drivingschool/guest/guest_choose_exam_category.dart';
import 'package:drivingschool/guest/guest_choose_learning_category.dart';
...
class MainHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => GuestChooseExamCategory()),
    );
    },
    child: const Text(
    'Egzamin',
    ...
    Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => GuestChooseLearningCategory()),
    );
    },
    child: const Text(
    'Nauka',
