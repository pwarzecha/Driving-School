...
class GuestLearningModePageB extends StatefulWidget {
  final String text6;
  GuestLearningModePageB({
    Key key,
    this.text6 =
  ...
  @override
  State<GuestLearningModePageB> createState() => _GuestLearningModePageBState();
}

class _GuestLearningModePageBState extends State<GuestLearningModePageB> {
